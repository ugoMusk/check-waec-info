...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                "function": "__gct",
                "vtp_trackingId": "G-4KCRL70YXM",
                "vtp_sessionDuration": 0,
                "tag_id": 1
            }, {
                "function": "__set_product_settings",
                "vtp_instanceDestinationId": "G-4KCRL70YXM",
...
*/
    ...
    var rd = {
      ...
      , wd = function(a, b, c) {
        ...
        if (a instanceof ed || a instanceof sb) {
            ...
            if ("toString" === b)
                return a instanceof ed ? a.N : a.toString();
            if ("hasOwnProperty" === b)
    ...
    var lf = [], mf = [], nf = [], of = [], pf = [], qf = {}, rf, sf, tf = function(a) {
        ...
        var e = qf[c], f = b && 2 === b.type && d.reportMacroDiscrepancy && e && -1 !== wf.indexOf(c), g = {}, k = {}, m;
        for (m in a)
    ...
    ni.oe = Number("0") || 0;
    ni.ia = "dataLayer";
    ni.fk = "ChAIgPaLqwYQmvH1urPbzrMJEiUA+0PbCkQgb/hQFOqeqK7TaNr55xcWv49xwsyYQ9pud+45ZVdfGgKq5w\x3d\x3d";
    var qi = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var lj;
    try {
        lj = JSON.parse(yb("eyIwIjoiTkciLCIxIjoiTkctUkkiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jb20ubmciLCI0IjoiIiwiNSI6dHJ1ZSwiNiI6ZmFsc2UsIjciOiJhZF9zdG9yYWdlfGFuYWx5dGljc19zdG9yYWdlfGFkX3VzZXJfZGF0YXxhZF9wZXJzb25hbGl6YXRpb24ifQ"))
    } catch (a) {
        O(123),
        kj(2),
        lj = {}
    ...
    aa.clearTimeout = function(a, b) {
        var c = [a], d;
        for (d in yj)
            yj.hasOwnProperty(d) && yj[d] === a && c.push(d);
    ...
    ;var Uj = [Q.g.K, Q.g.U, Q.g.O, Q.g.Ea]
      ...
      , Zj = function(a) {
        ...
        ++d.jd)
            a.hasOwnProperty(Q.g.fg) && l(mi, function(e) {
                return function(f) {
      ...
      , xk = function() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.we = b.siloed[g],
                    !mk && Ja(f.we.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.we.ctid
                        }
                    }(f)) ? mk = !0 : c.push(f.we);
    ...
    var zk = function() {
        for (var a = ik(), b = pk(), c = 0; c < b.length; c++) {
            ...
            d ? (d.state = 2,
            d.containers = pk(),
            d.destinations = rk()) : a.container[b[c]] = {
                state: 2,
                containers: pk(),
                destinations: rk()
            }
        ...
        for (var e = rk(), f = 0; f < e.length; f++) {
            ...
            g ? (g.state = 2,
            g.containers = pk(),
            g.destinations = rk()) : a.destination[e[f]] = {
                state: 2,
                containers: pk(),
                destinations: rk()
            }
            ...
            if ("array" === d) {
                ...
                for (var f in c)
                    if (!b.hasOwnProperty(f))
                        return !0;
                for (var g in b)
                    if (!c.hasOwnProperty(g) || cl(a, b[g], c[g]))
                        return !0
            }
        } catch (k) {
            O(72)
    ...
    var Ll = function(a) {
      ...
      , Kl = function(a, b) {
        ...
        if (c.fetch) {
            ...
            Jl(c, a, void 0 === b ? !1 : b, void 0 === d ? !1 : d)
    };
    var Ml = function() {};
    var Nl = function(a) {
    ...
    var Tl = function(a, b, c) {
        ...
        if (0 === k)
            ...
            m = 1 === k ? a.purpose && a.vendor ? Sl(a.purpose.legitimateInterests, b) && Sl(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
        return m
    }
      , Sl = function(a, b) {
        return !(!a || !a[b])
    ...
    function dm(a) {
        var b = {}
          , c = (b[Q.g.K] = a.bc["1"] ? "granted" : "denied",
        b);
        if (S(62)) {
            if (!0 !== a.gdprApplies) {
                fk([Q.g.K, Q.g.Ea, Q.g.O]);
    ...
    var om = function(a) {
      ...
      , qm = function() {
        var a = {}, b;
        for (b in mm)
            mm.hasOwnProperty(b) && (a[mm[b]] = Jj(b));
    ...
    var um = function(a) {
      ...
      , vm = function() {
        ...
        if (b && d)
            for (var f in zj)
                zj.hasOwnProperty(f) && zj[f].enabled && c.hasOwnProperty(f) && c[f].enabled ? e[f] = {
                    enabled: !0,
                    region: zj[f].region
                } : e[f] = {
                    enabled: !1,
    ...
    var Ym = {
      ...
      , hn = function(a, b) {
        ...
        var k = d.Mn, m = 4 + e + (k ? "" + Hg(2, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[k] : ""), n, p = d.Qm;
    ...
    ;var vn, wn = function() {
        ...
        a && (b.h[Q.g.Yd] = a.architecture,
        b.h[Q.g.Zd] = a.bitness,
        a.fullVersionList && (b.h[Q.g.ae] = a.fullVersionList.map(function(c) {
    ...
    ;var Sn = /(.*?)\*(.*?)\*(.*)/
      ...
      , Vn = /([^?#]+)(\?[^#]*)?(#.*)?/;
    function Wn(a, b) {
        var c = [Dc.userAgent, (new Date).getTimezoneOffset(), Dc.userLanguage || Dc.language, Math.floor(Ua() / 60 / 1E3) - (void 0 === b ? 0 : b), a].join("*"), d;
        if (!(d = Ln)) {
        ...
        if (Bm(z)) {
            ...
            Eo(function() {
                l(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = Qo(m), p = 0 !== So(m.split(".")).length ? m.split(".").slice(3) : [], q = {}, r;
    ...
    Vp))
      ...
      , Zp = function(a, b, c) {
        if (Ok && "config" === a && !(1 < jp(b).R.length)) {
            ...
            for (k in d) {
                var m = Yp(d[k], f);
                m.length && (Xp && console.log(m),
                g.push(k))
            }
            g.length && (g.length && Ok && Sp.push(b + "*" + g.join(".")),
    ...
    mq.prototype.push = function(a, b, c, d) {
        void 0 !== c && (1 === hq(this, c).status && (hq(this, c).status = 2,
        this.push("require", [{}], c, {})),
    ...
    mq.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length; ) {
            ...
            if (f.messageContext.deferrable)
                !g || hq(this, g).D ? (f.messageContext.deferrable = !1,
    ...
    function Hq(a) {
        var b = V(a.s, Q.g.xb)
          , c = V(a.s, Q.g.Mb);
        b && !c ? (a.eventName !== Q.g.sa && a.eventName !== Q.g.zd && O(131),
    ...
    var Rq = []
      ...
      , Wq = function(a) {
        Sq ? 0 <= a && a < Rq.length && Rq[a] && (Rq[a].disconnect(),
        Rq[a] = void 0) : z.clearInterval(a)
    };
    ...
    ;var is = !1;
    function js() {
        if (hs("join-ad-interest-group") && Ea(Dc.joinAdInterestGroup))
            return !0;
        is || (Gl(''),
        is = !0);
    ...
    function Ow(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (qi[d] || void 0 !== of[c][Oe.Qk] || Hi[d] || Eu(d, 2))
                    b[c] = !0
            }
        return b
    }
    function Pw(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && of[c] && !ri[String(of[c][Oe.za])])
                return !0;
        return !1
    }
    var Nf;
    ...
    var dx = {
        ...
        consent: function(a, b) {
            if (3 === a.length) {
                ...
                var c = Zw(a, b)
                  , d = a[1]
                  , e = a[2];
                b.fromContainerExecution || (e[Q.g.O] && O(139),
                e[Q.g.Ea] && O(140));
        ...
        set: function(a, b) {
            var c;
            2 == a.length && nb(a[1]) ? c = B(a[1]) : 3 == a.length && h(a[1]) && (c = {},
    ...
    function YB(a, b) {
        ...
        if (!Cy(d, "init", !1)) {
            ...
            b = Ey(b),
            TB(b, e),
            Ay(d, "reg", TB)) : f = SB("gtm.historyChange");
            XB(f);
            WB(f);
            UB("pushState", f);
            UB("replaceState", f);
    ...
    var $B = function(a, b) {
      ...
      , aC = function(a, b) {
        for (var c = Fn(Hn((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || Vc(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++)
            try {
      ...
      , jC = function() {
        ...
        var c = 0
          ...
          , e = function() {
            ...
            hC(),
            Cy("sdl", "init", !1) && !iC() && (Pc(z, "scroll", f),
            Pc(z, "resize", f),
            Ay("sdl", "init", !1)));
            d = !1
        }
    ...
    var tC = function(a, b, c) {
        ...
        function r() {
            if (u.length && 0 !== y) {
                ...
                c = function() {
                    d = 0;
                    c = p;
                    0 < u.length && u[0].Da === H.Da && (u.shift(),
                    Jx(t.createEvent("progress", H.Re, H.Te)));
                    r()
                }
                ;
      ...
      , xC = function(a, b) {
        if (!a.getAttribute("data-gtm-yt-inspected-" + b.nb) && (xc(a, "data-gtm-yt-inspected-" + b.nb),
        zC(a, b.Be))) {
            a.id || (a.id = AC());
            var c = z.YT
              , d = c.get(a.id);
            ...
            for (g in e)
                ...
                f.Me = g,
                e.hasOwnProperty(f.Me) && d.addEventListener(f.Me, function(k) {
                    return function(m) {
      ...
      , zC = function(a, b) {
        ...
        if (BC(c, "embed/")) {
            ...
            if (b) {
                var d;
                var e = -1 !== c.indexOf("?") ? "&" : "?";
                -1 < c.indexOf("origin=") ? d = c + e + "enablejsapi=1" : (rC || (rC = E.location.protocol + "//" + E.location.hostname,
                E.location.port && (rC += ":" + E.location.port)),
    ...
    function hE() {
        ...
        a.set("containerId", 'G-4KCRL70YXM'),
        a.set("version", '1'),
    ...
    var RE = function(a, b, c) {
      ...
      , VE = function(a, b) {
        var c = a.h[Q.g.sb];
        if (V(a.s, Q.g.xb) && V(a.s, Q.g.Mb) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!UE(c, a))
    ...
    var YE = function(a, b, c) {
        ...
        if (!(Math.floor(c.metadata.event_start_timestamp_ms / 1E3) > d.Oe + 60 * f))
            return a;
        var g = WE(b);
        if (!g)
            return a;
    ...
    var dF = function(a) {
      ...
      , hF = function(a) {
        var b = dF(a) || {}
          ...
          , e = ZE(a, c)
          , f = {};
        jo(b[Q.g.Wc], !!b[Q.g.X]) && (f = fF(a, d, e),
        f.clientId && f.Wf && (gF = !0));
        b[Q.g.X] && go(function() {
            var g = {}
              , k = SE(a);
            k && (g[d] = k);
      ...
      , wF = function(a, b, c) {
        ...
        l(a.h, function(t, u) {
            if (void 0 !== u && !Zh.hasOwnProperty(t)) {
                null === u && (u = "");
                var v;
                t !== Q.g.Id ? v = !1 : a.metadata.euid_mode_enabled || q ? (d.ecid = u,
                v = !0) : v = void 0;
                if (!v && t !== Q.g.ef) {
                    var w = u;
                    !0 === u && (w = "1");
                    ...
                    if (qF[t])
                        ...
                        var y;
                        tF[t] ? y = !0 : t !== Q.g.Mc ? y = !1 : ("object" !== typeof u && p(t, u),
                        y = !0);
                        y || p(t, u)
                    }
                }
        ...
        l(r, function(t, u) {
            void 0 !== u && ((null === u && (u = ""),
            t !== Q.g.Sa || f.uid) ? b[t] !== u && (e[(Ga(u) ? "upn." : "up.") + String(t)] = String(u),
        ...
        f.onprogress = function(g) {
            if (200 === f.status) {
                ...
                for (var n = m.indexOf("\n\n"); -1 !== n; ) {
                    ...
                    var u = p;
                    u && (AF(u.send_pixel, d.C),
                    AF(u.send_beacon, d.h));
                    m = m.substring(n + 2);
                    n = m.indexOf("\n\n")
                }
                d.D = m
    ...
    var HF = function(a, b, c, d) {
      ...
      , IF = function(a, b) {
        ...
        if (d || e) {
            ...
            r();
            d && (GF("https://stats.g.doubleclick.net/g/collect", "v=2&" + q.join("&")),
      ...
      , OF = function(a) {
        if (FE(a)) {
            ...
            var c = function(e) {
              ...
              , d = V(a.s, Q.g.Ca);
            void 0 !== d ? (c(d),
            S(72) && (a.h[Q.g.he] = "c")) : c(a.metadata.user_data);
    ...
    aa.Km = function(a) {
        ...
        try {
            ...
            if (0 <= xn.xl.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = HE(a);
            ...
            "http:" != g && "https:" != g && (O(29),
            a.isAborted = !0);
            Dc && "preview" == Dc.loadPurpose && (O(30),
            a.isAborted = !0);
            S(38) && (a.isAborted = !0);
            Hq(a);
            var k = oi.grl;
            ...
            if (a.metadata.euid_mode_enabled && Ep(a, "ccd_add_1p_data", !1)) {
                ...
                if (Wi(n)) {
                    ...
                    nb(n.selectors) && !a.metadata.user_data_from_manual && (a.metadata.user_data_from_manual = Vi(n.selectors)))
                }
            }
            var q = this.Jj, r;
            ...
            C && (this.N = !0);
            a.eventName == Q.g.sa && (V(a.s, Q.g.Ra, !0) ? (a.s.h[Q.g.da] && (a.s.D[Q.g.da] = a.s.h[Q.g.da],
            a.s.h[Q.g.da] = void 0,
            a.h[Q.g.da] = void 0),
            a.eventName = Q.g.nc) : a.isAborted = !0);
            ...
            var Fa = !1;
            wa || (Fa = a.metadata.is_first_visit = !0,
            wa = {
                sessionId: String(ma),
                Gc: 1,
                rd: !1,
            ...
            if (Fa)
                ...
                G.Sl(a);
            else if (G.Jl() > Ia || a.eventName == Q.g.nc)
                wa.rd = !0;
            a.metadata.euid_mode_enabled ? V(a.s, Q.g.Sa) ? wa.Dc = !0 : (wa.Dc && (wa.xe = void 0),
            wa.Dc = !1) : wa.Dc = !1;
            var Qa = wa.xe
              , jb = S(77) && FE(a);
            if (a.metadata.euid_mode_enabled || jb) {
                ...
                if (void 0 === Vg || Xd <= Vg)
                    a.h[Q.g.Id] = Gb.toString(),
                    a.metadata.enhanced_client_id_source = Xd
            }
            I ? (a.copyToHitData(Q.g.Ab, wa.sessionId),
            a.copyToHitData(Q.g.Wd, wa.Gc),
            a.copyToHitData(Q.g.Vd, wa.rd ? 1 : 0)) : (a.h[Q.g.Ab] = wa.sessionId,
            a.h[Q.g.Wd] = wa.Gc,
            a.h[Q.g.Vd] = wa.rd ? 1 : 0);
            ...
            if (!(S(48) && FE(a) || a.metadata.is_merchant_center || !1 === V(a.s, Q.g.fb)) && iD() && ak(Q.g.K)) {
                ...
                $v && 0 === (aw || 0) && (a.metadata.join_timer_sec = 60,
            ...
            if (void 0 !== V(a.s, Q.g.Vc))
                a.copyToHitData(Q.g.Vc);
            else {
                ...
                a: {
                    if (gF) {
                        var an = dF(a) || {};
                        if (an && an[Q.g.X])
                            for (var fw = Fn(Hn(a.h[Q.g.Ma]), "host", !0), ej = an[Q.g.X], Xg = 0; Xg < ej.length; Xg++)
                                if (ej[Xg]instanceof RegExp) {
                                    if (ej[Xg].test(fw)) {
                                        dj = !0;
                                        break a
                                    }
                ...
                if (!($m = dj)) {
                    ...
                    if (fj = ew)
                        a: {
                            for (var gw = ew.include_conditions || [], jI = Fn(Hn(a.h[Q.g.Ma]), "host", !0), bn = 0; bn < gw.length; bn++)
                                if (gw[bn].test(jI)) {
                                    fj = !0;
                                    break a
                                }
            ...
            FE(a) && ((Nj() || S(37)) && IE(a, "gcd", um(a.s)),
            Mj() && V(a.s, Q.g.wa) && IE(a, "adr", 1));
            if (FE(a)) {
                var jw = zs();
            ...
            S(70) && FE(a) && (a.metadata.speculative && IE(a, "sp", 1),
            a.metadata.is_syn && IE(a, "syn", 1),
            a.metadata.em_event && (IE(a, "em_event", 1),
            IE(a, "sp", 1)));
            if (S(7))
                if (!tn(z))
                    O(87);
            ...
            if (S(28)) {
                var cn = hs(gs());
                cn || dG || (dG = !0,
                Gl(''),
                cn = hs(gs()));
                cn && (a.h[Q.g.Jb] = "1")
            }
            ...
            var qI = this.h;
            S(92) && ak(Q.g.U) && (ij(qI),
            FE(a) && S(99) && (S(90) || S(91)) && (a.metadata.is_sgtm_service_worker = !0),
            S(90) && (S(99) && FE(a) ? bs(Mp(Op(a.s), "/_")) : S(103) && (wi || yi || FE(a) || bs())));
            if (FE(a)) {
                var rI = a.metadata.is_conversion;
                if ("page_view" === a.eventName || rI)
                    WF(this, a, Q.g.K),
                    S(56) && WF(this, a, Q.g.O)
            }
            this.H.Jh();
            a.copyToHitData(Q.g.zg);
            V(a.s, Q.g.Td) && (a.h[Q.g.Td] = !0,
            FE(a) || UF(a));
            if (a.isAborted) {
                a.s.onFailure();
                Bb();
    ...
    ;var eG = function(a) {
        if (S(52) && "prerendering"in E ? E.prerendering : "prerender" === E.visibilityState)
            return !1;
        a();
        return !0
    }
        ...
        if (!eG(a)) {
            var b = !1
              , c = function() {
                ...
                S(52) && Pc(E, "prerenderingchange", c),
                O(55))
            };
    ...
    iH.removeItem = function(a) {
        ...
        if (!b)
            throw Error("invalid program state");
        var c = b.hd();
        if (!jH[c] || !jH[c].hasOwnProperty("gtm." + a))
            return;
        delete jH[c]["gtm." + a];
    }
    ;
    ...
    (function(a) {
        ...
        try {
            ...
            if (ik().canonical[a]) {
                ...
                UI();
                if (S(35) && !Ai) {
                    for (var T = lj["7"], ma = T ? T.split("|") : [], fa = {}, ca = 0; ca < ma.length; ca++)
                        fa[ma[ca]] = !0;
